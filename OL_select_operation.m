function [individual]= OL_select_operation(n_d,value_space,fobj)
...
strength_num = ceil(log2(factor_num+1));
...
if fobj(indi_temp)>=fobj(indi_best_combine)
